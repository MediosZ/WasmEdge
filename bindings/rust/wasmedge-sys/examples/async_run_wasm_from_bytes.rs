...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let fut1 =
        vm.run_wasm_from_bytes_async(&wasm_bytes, "task1", 2000, "fib", [WasmValue::from_i32(20)]);
    let fut2 =
        vm.run_wasm_from_bytes_async(&wasm_bytes, "task2", 550, "fib", [WasmValue::from_i32(5)]);
